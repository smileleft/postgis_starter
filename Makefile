...
reindex:
  docker compose exec -e PGPASSWORD=$$POSTGRES_PASSWORD db psql -U $$POSTGRES_USER -d $$POSTGRES_DB -c "CREATE INDEX IF NOT EXISTS idx_seoul_districts_geom ON seoul_districts USING GIST(geom); ANALYZE seoul_districts;"
